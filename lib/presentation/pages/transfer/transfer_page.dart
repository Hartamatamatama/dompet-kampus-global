            ...
            child: Column(
              children: [
                ...
                AppField(
                  ...
                  prefixIcon: const Icon(DkgIcons.search, size: 20),
                ),
                const SizedBox(height: 14),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          if (c['fav'] as bool)
                            const Icon(DkgIcons.star, size: 18, color: AppColors.amber),
                        ],
                      ),
                    ),
                  ),
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Icon(DkgIcons.chevRight, size: 18, color: AppColors.slate400),
                    ],
                  ),
                ),
              ),
